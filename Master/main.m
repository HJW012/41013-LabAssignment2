...
pencil1 = EnvironmentObject('Type', 'target', 'ModelPath', 'pencil.ply', 'Pose', transl(0.15, 0.2, table.dimensions(1,3)), 'Dimensions', [0.1734 0.0123 0.0124], 'GeneralColour', 'y');
pencil2 = EnvironmentObject('Type', 'target', 'ModelPath', 'pencil.ply', 'Pose', transl(-0.15, -0.25, table.dimensions(1,3)), 'Dimensions', [0.1734 0.0123 0.0124], 'GeneralColour', 'y');
