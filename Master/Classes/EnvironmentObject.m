...
classdef EnvironmentObject < handle
   ...
   methods
       ...
       %% Move Object - move object with end effector of robot and display
       function MoveObject(self, pose)
           self.pose = pose * transl(self.modelMidPoint(1,1),self.modelMidPoint(1,2),self.modelMidPoint(1,3));
           updatedPoints = [self.pose * [self.modelV, ones(self.vertexCount, 1)]']';
           self.modelMesh.Vertices = updatedPoints(:, 1:3);
       end
       %% Remove object
