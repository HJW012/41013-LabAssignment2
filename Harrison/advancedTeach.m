%SerialLink.advancedTeach Graphical advancedTeach pendant
%
% R.advancedTeach(Q, OPTIONS) allows the user to "drive" a graphical robot by means
...
%
% R.advancedTeach(OPTIONS) as above but with options and the initial joint angles
...
function advancedTeach(robot, varargin)
    ...
    for j=1:n
        ...
        set(handles.edit(j), ...
            'Interruptible', 'off', ...
            'Callback', @(src,event)advancedTeach_callback(src, robot.name, j, handles));
